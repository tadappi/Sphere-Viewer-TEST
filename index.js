/*
 * Marzipano custom edition — click-to-zoom (精密変換) + delayed link open
 */
'use strict';
...
(function () {
  ...
  panoElement.addEventListener('click', function (e) {
    ...
    var targetYaw = coords.yaw;
    var targetPitch = coords.pitch;
    var targetFov = Math.min(before.fov * 0.6, 0.35); // 寄り具合
